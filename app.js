...
app.get('/places', cors(corsOptions), async(req,res) => {
    try {
...
app.get('/places/:id', cors(corsOptions), async(req,res) => {
    try {
        const {id} = req.params;
...
app.put('/places/:id', cors(corsOptions), async(req,res) => {
    try {
        const {id} = req.params;
...
//Eliminar producto
app.delete('/places/:id', cors(corsOptions), async(req, res) =>{
    try {
        const {id} = req.params;
...
app.post('/places', cors(corsOptions), async(req, res) => {
    try {
